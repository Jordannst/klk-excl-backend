...
import { drawPageNumbers, PDF_MARGIN_MM } from './pdfLayout';
...
export function generateTransactionPdf(payload: TransactionPdfRequest): Buffer {
  ...
  autoTable(doc, {
    ...
    theme: 'grid',
    styles: { font: 'helvetica', fontSize: showKet ? 7 : 8, cellPadding: 1.4, lineColor: [0, 0, 0], lineWidth: 0.15, overflow: 'linebreak', valign: 'middle' },
    headStyles: { fillColor: [240, 240, 240], textColor: [0, 0, 0], fontStyle: 'bold', halign: 'center' },
    footStyles: { fillColor: [255, 255, 255], textColor: [0, 0, 0], fontStyle: 'bold' },
    columnStyles: {
      0: { halign: 'center', cellWidth: 8 },
      ...(showDate ? { 1: { cellWidth: 21 } } : {}),
      [tableColumns.indexOf('C')]: { halign: 'center', cellWidth: 8 },
      [tableColumns.indexOf('Kg')]: { halign: 'center', cellWidth: 8 },
      [tableColumns.indexOf('Min')]: { halign: 'center', cellWidth: 8 },
      [tableColumns.indexOf('Tarif')]: { halign: 'right', cellWidth: 18 },
      [tableColumns.indexOf('Jumlah')]: { halign: 'right', cellWidth: 22 },
    },
  });
